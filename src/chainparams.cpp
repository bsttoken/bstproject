...
{
    const char* pszTimestamp = "ElephantChain";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1520222837, 222837, 0x1e00ffff, 1, (1 * COIN));
        ...
        assert(hashGenesisBlock == uint256("0x352e139dde36aea6c184833abd4dad16c18d15f88321fec1808b6c6d07f74f1c"));
        assert(genesis.hashMerkleRoot == uint256("0x8c7e8bffdde69d2eee709bbb5df3b8ff41bd19eded4f301a82aba982973b2a1a"));
        ...
        vSeeds.push_back(CDNSSeedData("net11", "120.78.68.37"));
        vSeeds.push_back(CDNSSeedData("net22", "119.23.28.216"));
        vSeeds.push_back(CDNSSeedData("net33", "39.108.134.232"));
        vSeeds.push_back(CDNSSeedData("net1", "bsta.aliredian.com"));
        vSeeds.push_back(CDNSSeedData("net2", "bstb.aliredian.com"));
        ...
        strDarksendPoolDummyAddress = "EMDayCHyVeTg9yjwtMSNAx1HuyNiE4eBX8";
